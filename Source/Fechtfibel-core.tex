...
\begin{itemize}
    ...
    \item \textbf{Transkription und Übersetzung zum langen Schwert} nach Dierk Hagedorn (siehe \ref{nuetzliche_links})
...
Wiktenauer, siehe \ref{nuetzliche_links}:
