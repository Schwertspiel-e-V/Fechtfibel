...
\usepackage[T1, EU1]{fontenc} % Output font encoding for international characters
\usepackage[utf8] {inputenc} %inpunencoding for QOL
...
\minipage{0.5\textwidth}
  ...
  \caption{Vom Tag und Alber}\label{fig:alber1}
\endminipage\hfill
\minipage{0.4\textwidth}
  \includegraphics[width=\linewidth]{Haupthuten2.jpg}
  \caption{Ochs und Pflug}\label{fig:alber2}
\endminipage\hfill
\end{figure}
